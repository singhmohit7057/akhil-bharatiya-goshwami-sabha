...
export function TermsOfService() {
  ...
  return (
    <>
      <SEO
        title="Terms of Service | Akhil Bharatiya Goswami Sabha Paschim Bangal"
        description="Terms and conditions for using the Akhil Bharatiya Goswami Sabha Paschim Bangal website."
